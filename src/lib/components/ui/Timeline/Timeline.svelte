...
<div
        class="w-full bg-[#0E0E0E] font-sans md:px-10"
...
>
    <div class="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p
                class="text-neutral-700 dark:text-neutral-300 text-sm md:text-base "
        >
            With three years of professional experience, I have developed a strong foundation in my field, consistently
            delivering high-quality results in dynamic corporate environments. I am dedicated to continuous learning and
            growth, and I thrive on collaborating with teams to achieve organizational goals. Please feel free to review
            my experience section to learn more about my skills and accomplishments.
        </p>
    </div>
        ...
        {#each timelineData as item, index}
            <div class="flex justify-start pt-10 md:pt-40 md:gap-10">
                ...
                >
                    ...
                    <h3 class="hidden md:block text-xl md:pl-20 md:text-5xl font-bold text-neutral-400">
                        {item.title}
                    </h3>
                </div>
