...
<div
        ...
        class={cn(
    "group relative flex  overflow-hidden rounded-lg bg-neutral-100 dark:bg-neutral-900 border text-black dark:text-white justify-center ",
    className
  )}
>
    ...
    >
        <div
                use:motion
                class="pointer-events-none absolute -inset-px rounded-lg opacity-0 transition-opacity duration-300 group-hover:opacity-100"
        />
    </Motion>
</div>
